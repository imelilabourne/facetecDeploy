export var Config = (function () {
    ...
    var DeviceKeyIdentifier = "diE6RdAJlbNhgpxpH8VE2WNd6O0FS1u2";
    ...
    function retrieveConfigurationWizardCustomization(FaceTecSDK) {
        var sdkImageDirectory = "src/assets/core-sdk/FaceTec_images/";
        
        // For Color Customization
        var outerBackgroundColor = "#daf2e3";
        var frameColor = "#ffffff";
        var borderColor = "#ffffff";
        var ovalColor = "#0db14b";
        var dualSpinnerColor = "#0db14b";
        var textColor = "#0db14b";
        var buttonAndFeedbackBarColor =  "#0db14b";
        var buttonAndFeedbackBarTextColor = "#ffffff";
        var buttonColorPressed = "#0db14b";
